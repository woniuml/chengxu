        ...
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
					...
					<li class="dropdown ${(index==3)?string('active','')}">
						...
						<ul class="dropdown-menu">
							<@shiro.hasPermission name="/role/index.shtml">
								<li><a href="${basePath}/role/index.shtml">属性列表</a></li>
							</@shiro.hasPermission>
							<@shiro.hasPermission name="/role/allocation.shtml">
								<li><a href="${basePath}/role/allocation.shtml">属性分配</a></li>
							<!-- 这是个jsp页面 -->
							</@shiro.hasPermission>
				...
				<li>
					<a class="dropdown-toggle" target="_blank" href="xxx" target="_blank">
						ABAC<span class="collapsing"></span>
					</a>
				</li>	          
				<li>
					<a class="dropdown-toggle" href="XXXX" target="_blank">
						ABAC介绍<span class="collapsing"></span>
					</a>
				</li>	          
				...
				<li class="dropdown ${(index==10)?string('active','')}" style="color:#fff;">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown"  
						<@shiro.user>  
							...
							${token.nickname?default('出错')}<span class="caret"></span></a>
